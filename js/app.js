  ...
  self.markerItem().forEach(function(placeItem) {
    ...
    function toggleBounce() {
      if (placeItem.marker.getAnimation() !== null) {
        ...
        setTimeout(function(){ placeItem.marker.setAnimation(null); }, 600);
      }
    }
          ...
          $.ajax ({
            ...
            success: function ( JSON ){
              var venues = JSON.response.venues;
                  ...
                  infoContent = '<div id="content">' + windowNames + '<p>' + 'Location: ' + venues[0].location.address + '</p>' + '<p>' +  '</p>'  + 'Phone Number: ' +  venues[0].contact.phone+ '</div>';
